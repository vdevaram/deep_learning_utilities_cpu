...
# setup calibration 
cd $VINO_WORKSPACE/models/faster_rcnn_resnet50_coco_2018_01_28
...
cp $VINO_HOME/intel/openvino/deployment_tools/open_model_zoo/tools/accuracy_checker/configs/faster_rcnn_resnet50_coco.yml .
# calibration
python $VINO_HOME/intel/openvino/deployment_tools/tools/calibration_tool/calibrate.py -c $VINO_WORKSPACE/models/faster_rcnn_resnet50_coco_2018_01_28/faster_rcnn_resnet50_coco.yml  -d $VINO_WORKSPACE/models/faster_rcnn_resnet50_coco_2018_01_28/dataset_definitions.yml -M $VINO_HOME/intel/openvino/deployment_tools/model_optimizer --tf_custom_op_config_dir $VINO_WORKSPACE/models/faster_rcnn_resnet50_coco_2018_01_28/ --models $VINO_WORKSPACE/models/faster_rcnn_resnet50_coco_2018_01_28/ --source $VINO_WORKSPACE/coco_data/ --annotations  $VINO_WORKSPACE/coco_data/ -e $VINO_WORKSPACE/samples/intel64/Release/lib  -cfc  -thboundary 99 --progress bar  --batch_size 1 -o ./int8
# Benchmark 
$VINO_WORKSPACE/samples/intel64/Release/benchmark_app -m $VINO_WORKSPACE/models/faster_rcnn_resnet50_coco_2018_01_28/fp32/frozen_inference_graph.xml -niter 100  -nireq <multiples of cores> -nstreams <multiples of cores>
#FP32 inference
...
# INT8 inference
$VINO_HOME/intel/openvino/deployment_tools/inference_engine/demos/python_demos/object_detection_demo_ssd_async/object_detection_demo_ssd_async.py -i "cam" -m $VINO_WORKSPACE/models/faster_rcnn_resnet50_coco_2018_01_28/int8/frozen_inference_graph_i8.xml -d CPU  -l $VINO_WORKSPACE/samples/intel64/Release/lib/libcpu_extension.so
